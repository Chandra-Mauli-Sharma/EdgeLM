...
class OnboardingActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        points.addView(feature("⚡", "Shared by every app", "Download a model once and any EdgeLM app can use it — saving space and memory."))
        root.addView(points)
        ...
        root.addView(text("You'll pick a model on the next screen.", 12.5f, Color.parseColor("#84939B"), false, Gravity.CENTER)
